...
st.markdown("""
    ...
    .main-header {
        background: linear-gradient(to right, #003566, #001845);
        color: white;
        padding: 2rem;
...
with st.form(key="vehicle_form"):
    ...
    with col4:
        mileage = st.number_input("🧭 Mileage", min_value=0, step=500)
...
if submitted and concern and make and model and year:
    ...
    if match:
        ...
        st.markdown("<h3 class='section-title'>🔎 Top 3 Repair Solutions</h3>", unsafe_allow_html=True)
